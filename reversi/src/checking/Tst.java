...
public class Tst {
	 ...
	 */
//	public static void main(String[] args) throws NoNextStateException {	
...
//		int boardSize = 8;
//		
//		List<Attribute> features = Reversi.getFeatures(boardSize);
//		
//		WekaEncoder encoder;
//		try {
...
//		
//			Reversi game1 = new Reversi(boardSize);
//			Reversi game2 = new Reversi(boardSize);
//			
//			while(!game1.isTerminateState()){
//				game1 = game1.getNextRandomState();
//			}
//			while(!game2.isTerminateState()){
